  ...
  try {
    const html = `
      ...
      <body>
        <h1>TravelX</h1>
        <h2>Welcome aboard, Captain ${firstName}!</h2>
        <p>We’re thrilled to welcome you to the TravelX family.</p>
        <p>Start your journey today and make every ride amazing!</p>
        <p>Happy riding!<br>The TravelX Team</p>
      </body>
      </html>
    `;
    ...
    console.log("Captain welcome email sent via Brevo");
  } catch (error) {
    console.error("Captain email error:", error.response?.data || error.message);
  }
};
