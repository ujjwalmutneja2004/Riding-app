  ...
  try {
    const html = `
      ...
      <body>
        <h1>TravelX</h1>
        <h2>Welcome aboard, ${firstName}!</h2>
        <p>Thank you for joining TravelX.</p>
        <p>You can now book rides and enjoy seamless travel.</p>
        <p>Happy riding!<br>The TravelX Team</p>
      </body>
      </html>
    `;
    ...
    console.log("User welcome email sent via Brevo");
  } catch (error) {
    console.error("User email error:", error.response?.data || error.message);
  }
};
